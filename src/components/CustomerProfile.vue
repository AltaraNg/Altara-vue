    ...
    >
      ...
      >
        <div class="customer-profile card position-relative">
          ...
          <div
            class="col-md-4 col-sm-4 col-12 px-0 pb-md-4 pb-sm-3 pb-0 pt-md-5 pt-4 float-left"
          >
            <div class="pt-md-3 pt-sm-2 pt-1">
              ...
              <div
                class="justify-content-center d-flex position-relative z-1 pt-md-4 pt-sm-4 pt-2"
              >
                <span class="w-50">
          ...
          <div
            class="col-md-8 col-sm-8 col-12 px-0 pb-4 pt-md-5 pt-sm-5 pt-0 float-left"
          >
            <div class="pt-md-4 pt-0 clearfix">
              ...
              <div
                class="float-left p-0 m-0 col-md-4 col-sm-6 d-flex justify-content-center"
              >
                <h4
                  class="mt-0 pt-md-5 pt-sm-4 pt-0 mb-md-5 mb-sm-4 mb-4 text-muted"
                >
              ...
              <div
                class="float-left p-0 m-0 col-md-4 col-12 d-flex justify-content-center"
              >
    ...
    methods: {
      ...
      verifyModal() {
        this.$modal.show(
          ...
          { customer: this.customer, verificationList: this.verificationList },
          {
