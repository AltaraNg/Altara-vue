    ...
    <div class="form-group mb-5 col-md-12 px-md-3 px-1 float-left">
      <div class="form-group col-md-3 px-md-3 px-1 mt-2 float-left">
        ...
        <select
          ...
          :class="
            memberHasError('newCustomer.employment_status') ? 'is-invalid' : ''
          "
          v-validate="'required'"
          name="emp"
        >
      ...
      <div
        v-if="memberHasError('newCustomer.occupation')"
        class="invalid-feedback"
      >
        <div class="error" v-if="!$v.formData.newCustomer.occupation.required">
    ...
    >
      <div class="form-group col-md-6 px-md-3 px-1 float-left">
        ...
        <input
          ...
          :class="
            memberHasError('newCustomer.working_individual_Phone_number')
              ? 'is-invalid'
              : ''
          "
        />
        ...
        >
          <div
            class="error"
            v-if="
              !$v.formData.newCustomer.working_individual_Phone_number.minLength
            "
          >
          ...
          <div
            class="error"
            v-if="
              !$v.formData.newCustomer.working_individual_Phone_number.required
            "
          >
          ...
          <div
            class="error"
            v-if="
              !$v.formData.newCustomer.working_individual_Phone_number.maxLength
            "
          >
            The maximum phone number is 11 digits.
          </div>
        </div>
      </div>
      ...
      <div class="form-group col-md-6 px-md-3 px-1 float-left">
        ...
        <input
          ...
          :class="
            memberHasError('newCustomer.name_of_company_or_business')
              ? 'is-invalid'
              : ''
          "
        />
        ...
        >
          ...
          >
            The name of company is required.
          </div>
        </div>
      </div>
      ...
      <div class="form-group col-md-6 px-md-3 px-1 float-left">
        ...
        <input
          ...
          v-validate="'required'"
          :class="
            memberHasError('newCustomer.current_sal_or_business_income')
              ? 'is-invalid'
              : ''
          "
        />
        ...
        >
          <div
            class="error"
            v-if="
              !$v.formData.newCustomer.current_sal_or_business_income.required
            "
          >
            The current salary or business income is required.
          </div>
        </div>
      </div>

      <div
        class="form-group col-md-6 px-md-3 px-1 float-left"
        v-if="formData.newCustomer.employment_status === 'formal'"
      >
      ...
      <div
        class="form-group col-md-6 px-md-3 px-1 float-left"
        v-if="formData.newCustomer.employment_status === 'informal(business)'"
      >
      ...
      >
        ...
        <div
          v-if="memberHasError('newCustomer.bank_account')"
          class="invalid-feedback"
        >
          <div
            class="error"
      ...
      <div class="form-group col-md-3 px-md-3 px-1 float-left">
        ...
        <select
          ...
          :class="
            memberHasError('newCustomer.years_of_existence_or_work_duration')
              ? 'is-invalid'
              : ''
          "
        >
        ...
        >
          <div
            class="error"
            v-if="
              !$v.formData.newCustomer.years_of_existence_or_work_duration
                .required
            "
          >
            The duration in current work is required.
          </div>
        </div>
      </div>
      ...
      <div class="form-group col-md-9 px-md-3 px-1 float-left">
        ...
        <div
          v-if="memberHasError('newCustomer.days_of_work')"
          class="invalid-feedback"
        >
          <div
            class="error"
      ...
      <div class="form-group col-md-4 px-md-3 px-1 float-left">
        ...
        <input
          ...
          :class="
            memberHasError('newCustomer.comp_street_name') ? 'is-invalid' : ''
          "
        />
        ...
        >
          ...
          >
            The company's street is required.
          </div>
        </div>
      </div>
      ...
      <div class="form-group col-md-4 px-md-3 px-1 float-left">
        ...
        <input
          ...
          v-validate="'required|max:50'"
          :class="
            memberHasError('newCustomer.comp_house_no') ? 'is-invalid' : ''
          "
        />
        ...
        >
          ...
          >
            The company's house number is required.
          </div>
        </div>
      </div>
      ...
      <div class="form-group col-md-4 px-md-3 px-1 float-left">
        ...
        />
        <div
          v-if="memberHasError('newCustomer.cadd_nbstop')"
          class="invalid-feedback"
        >
          <div
            class="error"
      ...
      <div class="form-group col-md-4 px-md-3 px-1 float-left">
        ...
        />
        <div
          v-if="memberHasError('newCustomer.comp_area')"
          class="invalid-feedback"
        >
          <div class="error" v-if="!$v.formData.newCustomer.comp_area.required">
            Please provide area.
          </div>
        </div>
      ...
      <div class="form-group col-md-4 px-md-3 px-1 float-left">
        ...
        <input
          ...
          v-validate="'required|max:50'"
          :class="
            memberHasError('newCustomer.company_city') ? 'is-invalid' : ''
          "
        />
      ...
      <div class="form-group col-md-4 px-md-3 px-1 float-left">
        ...
        <select
          ...
          v-validate="'required'"
          :class="
            memberHasError('newCustomer.company_state') ? 'is-invalid' : ''
          "
        >
      ...
      <div class="form-group col-md-4 px-md-3 px-1 float-left">
        ...
        <input
          ...
          :class="
            memberHasError('newCustomer.company_telno') ? 'is-invalid' : ''
          "
        />
      ...
      <div class="form-group col-md-4 px-md-3 px-1 float-left">
        ...
        <input
          ...
          :class="
            memberHasError('newCustomer.cvisit_hour_from') ? 'is-invalid' : ''
          "
          v-validate="'required'"
        />
      ...
      <div class="form-group col-md-4 px-md-3 px-1 float-left">
        ...
        <input
          ...
          v-validate="'required'"
          :class="
            memberHasError('newCustomer.cvisit_hour_to') ? 'is-invalid' : ''
          "
        />
