<template>
	<div style="margin-left: 5rem; margin-right: 5rem;">
		<AutocompleteSearch title="Informal Recommendation Service" @customer-selected="processForm"
			:url="'/api/customer/autocomplete'" />
		<form-wizard @on-complete="logAmounts()" title="Fill Form to know recommended plan" subtitle="" color="#2975A5"
			error-color="#FF0000" v-if="customer">

			<tab-content title="Plan Details" :before-change="beforeTabSwitch1">
				<div class="row">

					<div class="col form-group">
						<label for="amount" class="form-control-label">Customer Type</label>
						<select class="custom-select w-100" v-model="customer_type" v-validate="'required'">
				...
				<div class="row">
					...
					<div class="col form-group">
						<label for="custom-date" class="form-control-label">Total Product Price
						</label>
						<!-- <input
					...
					<div class="col form-group">
						...
						<select class="custom-select w-100" v-model="form1[1]" v-validate="'required'">
				...
				<div class="row">
					...
					<div class="col form-group">
						...
						<select class="custom-select w-100" v-model="form1[3]" v-validate="'required'">
					...
					<div class="col form-group">
						...
						<select class="custom-select w-100" v-model="form1[2]" v-validate="'required'">
			...
			<tab-content title="1st Month" :before-change="beforeTabSwitch2">
				<div class="row">
					<div class="col form-group">
						<label for="7th-day" class="form-control-label">Max Balance (6th, 7th, 8th)
						</label>
						<currency-input :options="inputOptions" v-model="form2[0]" class="form-control w-100" />
					</div>
					<div class="col form-group">
						<label for="14th-day" class="form-control-label">Max Balance (13th, 14th, 15th)
						</label>
				...
				<div class="row">
					<div class="col form-group">
						<label for="21st-day" class="form-control-label">Max Balance (20th, 21st, 22nd)
						</label>
						<currency-input :options="inputOptions" v-model="form2[2]" class="form-control w-100" />
					</div>
					<div class="col form-group">
						<label for="28th-day" class="form-control-label">Max Balance (27th, 28th, 29th)
						</label>
			...
			<tab-content title="2nd Month" :before-change="beforeTabSwitch3">
				<div class="row">
					<div class="col form-group">
						<label for="custom-date" class="form-control-label">Max Balance (6th, 7th, 8th)
						</label>
						<currency-input :options="inputOptions" v-model="form3[0]" class="form-control w-100" />
					</div>
					<div class="col form-group">
						<label for="custom-date" class="form-control-label">Max Balance (13th, 14th, 15th)
						</label>
				...
				<div class="row">
					<div class="col form-group">
						<label for="custom-date" class="form-control-label">Max Balance (20th, 21st, 22nd)
						</label>
						<currency-input :options="inputOptions" v-model="form3[2]" class="form-control w-100" />
					</div>
					<div class="col form-group">
						<label for="custom-date" class="form-control-label">Max Balance (27th, 28th, 29th)
						</label>
