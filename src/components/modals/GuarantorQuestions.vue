  ...
  <transition>
    <div>
      ...
      <div class="modal-body mx-4">
        ...
        <h4>
          This section is for Guarantors,
        ...
        <form>
          ...
          <div class="form-group my-3">
            <label for="checklist10" class=""
              ...
              (e.g. birth of a child, burial, children going to
              university)</label
            ><br />
            <div class="form-check form-check-radio form-check-inline">
              <label class="form-check-label">
          ...
          <div class="form-group my-3">
            <label for="bill">Are you employed or do you own a business?</label>
            <br />
          ...
          <div class="form-group">
            <label for="exampleFormControlTextarea2"
              >What was the outcome of their payment? Did they ever default and
              if yes how did you handle it?</label
            >
            <textarea
