        ...
        <form @submit.prevent="onSave">
          <div class="my-4 clearfix p-5 row bg-white shadow-sm card-radius">
            ...
            <div class="form-group col-md-6 col-12 float-left px-0 px-md-3">
              ...
              />
              <small v-if="errors.first('feature')">{{
            ...
            <div class="form-group col-md-6 col-12">
              <label for="product_type" class="form-control-label"
                >Product Type
              </label>
              <br />
              <select
    ...
    methods: {
      async prepareForm(data) {
        ...
        if (this.mode === "edit") {
          ...
          form.product_type_id = this.getParent(
            data.product_type,
            this.product_types
          ).id;
              ...
              (this.mode === "edit"
                ...
                .then(({ data }) => {
                  if (data.status === "success") {
                    ...
                    return this.$router.push({ path: "/log/products" });
                  }
                })
                .catch(({ response: r }) => {
                  let { data, status } = r;
