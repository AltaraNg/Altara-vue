...
const SupplierList = () =>
    import ("../views/LOG/supplier/suppliers.vue");
const BrandForm = () =>
    import ("../views/LOG/brand/form.vue");
const BrandList = () =>
    import ("../views/LOG/brand/brands.vue");
const CategoryForm = () =>
    import ("../views/LOG/category/form.vue");
const CategoryList = () =>
    import ("../views/LOG/category/categories.vue");
const ProductForm = () =>
    import ("../views/LOG/product/form.vue");
const ProductList = () =>
    import ("../views/LOG/product/products.vue");
const Renewal = () =>
    import ("../views/FSL/renewal/renewal.vue");
const CashLogger = () =>
    import ("../views/FSL/cash_logger/cash_logger.vue");
const PaymentLogger = () =>
    import ("../views/FSL/payment_logger/payment_logger.vue");
const ACC = () =>
    import ("../views/ACC/index.vue");
const ACCHome = () =>
    import ("../views/ACC/HomePage.vue");
const Reconcile = () =>
    import ("../views/ACC/reconcile/reconcile.vue");
