              ...
              <div class="col-sm-12 px-0 px-md-3">
                ...
                <div class="input-group">
                  <input
                    ...
                    v-validate="'required|min:6|max:25'"
                  />
                  <span class="input-group-addon" @click="showPassword1"
                    ><i class="ml-2" :class="icon1"></i
                  ></span>
                </div>
                <small
                  class="error-control"
...
<script>
  ...
  export default {
    ...
    methods: {
      validator() {
        if (
          ...
          this.errors.first("confirm password")
        ) {
          return true;
        }
      },
      showPassword() {
        ...
        this.icon =
          this.icon === "far fa-eye-slash" ? "far fa-eye" : "far fa-eye-slash";
      },
      showPassword1() {
        this.pass1 = this.pass1 === "password" ? "text" : "password";
        this.icon1 =
          this.icon1 === "far fa-eye-slash" ? "far fa-eye" : "far fa-eye-slash";
      },
      async reset() {
    ...
    mounted() {
      this.cardMT =
        (window.innerHeight - $("#forgotPasswordCard").height()) / 2;
      this.$LIPS(false);
    },
  };
</script>
