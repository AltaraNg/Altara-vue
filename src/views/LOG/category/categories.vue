      ...
      <div class="mt-2 mt-lg-3 row attendance-head">
        ...
        <div class="col-md-4">
          <router-link :to="{ name: 'categoryCreate' }">
            <button class="btn btn-primary bg-default mt-0 myBtn float-right">
                ...
                <table class="table table-bordered table-striped">
                  <tbody>
                    ...
                    <tr>
                      ...
                      <td>
                        {{
                          categoryItem.created_at
                            ? categoryItem.created_at.split(" ")[0]
                            : "Not Available"
                        }}
                      </td>
                    </tr>
                    <tr>
                      ...
                      <td>
                        {{
                          categoryItem.created_at
                            ? categoryItem.created_at.split(" ")[1]
                            : "Not Available"
                        }}
                      </td>
                    </tr>
