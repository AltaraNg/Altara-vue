            ...
            <div class="card-body clearfix px-5">
              <div class="col-sm-12 px-0 px-md-3">
                ...
                <small class="error-control" v-if="errors.first('Staff ID')"
                  >{{ errors.first("Staff ID") }}
                </small>
                <small class="error-control" v-if="error.staff_id">{{
                  error.staff_id[0]
                }}</small>
              </div>
              <div class="col-sm-12 px-0 px-md-3">
              ...
              <span class="text-center float-left w-100 pb-4"
                >Forgot Password?
                <router-link class="text-info" to="/password/forgot"
