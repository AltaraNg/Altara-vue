          ...
          <div class="p-5 row bg-white shadow-sm card-radius">
            ...
            <div class="form-group col-md-6 col-12 float-left px-0 px-md-3">
              ...
              <textarea
                ...
                v-validate="'required'"
              ></textarea>
              <small v-if="errors.first('reason')">{{
                errors.first("reason")
              }}</small>
            </div>
            ...
            <div class="form-group col-md-6 col-12 float-left px-0 px-md-3">
              <div class="form-check pl-3 ml-1">
                ...
                <label class="form-check-label" for="penalty"
                  >Add Penalty Automatically</label
                >
              </div>
              <input
                v-if="autoPenalty"
              ...
              <small v-if="errors.first('penalty')">{{
                ...
                .then(({ data }) => {
                  if (data.saved) {
                    log(
                      `CautionSent`,
                      `${
                        this.users.find(({ id }) => id === this.form.user_id)
                          .staff_id
                      }`
                    );
