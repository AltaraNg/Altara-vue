  ...
  <transition name="fade">
    <div id="reminder" class="attendance">
      ...
      <div v-if="mode === 'old'">
        ...
        <order
          v-if="show"
          :start-index="orders.from"
          :pre-loaded-order="response"
          :mode="'normal-list'"
        />
        ...
        <div class="mt-1 attendance-body" v-if="show && orders.current_page">
          <div class="mb-5 px-0 row align-items-center">
            ...
            <div class="clearfix w-100 mt-4 d-flex bd-highlight">
              <div
                class="col d-flex justify-content-start align-items-center pl-0"
              >
                <strong class="light-heading float-left">
                  Displaying: {{ orders.from }} - {{ orders.to }} of
                  {{ orders.total }}
                </strong>
              </div>
              ...
              <div class="col d-flex justify-content-center align-items-center">
                <div class="mr-5">
                  <span class="d-inline light-heading mr-2"
                    >set current Page</span
                  >
                  <input
              ...
              >
                <ul class="pagination pagination-lg mb-0">
                  <!---->
                  <li
                    :class="{ disabled: !orders.first_page_url }"
                    class="page-item"
                  >
                    <a href="javascript:" @click="prev(1)" class="page-link"
                      >First</a
                    >
                  </li>
                  <li
                    :class="{ disabled: !orders.prev_page_url }"
                    class="page-item"
                  >
                    <a href="javascript:" @click="prev()" class="page-link"
                      >prev</a
                    >
                  </li>
                  <!---->
                  <li class="page-item">
                    <span class="page-link"
                      >Current Page: {{ orders.current_page }}</span
                    >
                  </li>
                  <!---->
                  <li
                    :class="{ disabled: !orders.next_page_url }"
                    class="page-item"
                  >
                    <a href="javascript:" @click="next()" class="page-link"
                      >Next</a
                    >
                  </li>
                  <li
                    :class="{ disabled: !orders.last_page_url }"
                    class="page-item"
                  >
                    <a
                      href="javascript:"
                      @click="next(orders.last_page)"
                      class="page-link"
                      >Last</a
                    >
                  </li>
