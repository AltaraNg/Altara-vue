  ...
  <div>
    <div class="form-group">
      ...
      <div class="form-group col-md-4 px-md-3 px-1 float-left">
        ...
        />
        <div
          v-if="memberHasError('newCustomer.add_street')"
      ...
      <div class="form-group col-md-4 px-md-3 px-1 float-left">
        ...
        />
        <div
          v-if="memberHasError('newCustomer.add_houseno')"
          class="invalid-feedback"
        >
          <div
            class="error"
      ...
      <div class="form-group col-md-4 px-md-3 px-1 float-left">
        ...
        />
        <div
          v-if="memberHasError('newCustomer.add_nbstop')"
          class="invalid-feedback"
        >
          <div
            class="error"
          ...
          >
            Please provide the nearest Bustop.
          </div>
        </div>
      ...
      <div class="form-group col-md-4 px-md-3 px-1 float-left">
        ...
        <input
          ...
          :class="
            memberHasError('newCustomer.area_address') ? 'is-invalid' : ''
          "
          v-validate="'required|max:25'"
        />
        <div
          v-if="memberHasError('newCustomer.area_address')"
          class="invalid-feedback"
        >
          <div
            class="error"
      ...
      <div class="form-group col-md-4 px-md-3 px-1 float-left">
        ...
        <div v-if="memberHasError('newCustomer.city')" class="invalid-feedback">
          <div class="error" v-if="!$v.formData.newCustomer.city.required">
      ...
      <div class="form-group col-md-4 px-md-3 px-1 float-left">
        ...
        <div
          v-if="memberHasError('newCustomer.state')"
          class="invalid-feedback"
        >
          <div class="error" v-if="!$v.formData.newCustomer.state.required">
