      ...
      <div class="card">
        ...
        <div class="card-body pl-4 pr-4">
          <form @submit.prevent="onSave" v-if="show">
            ...
            <div class="clearfix">
              <div class="form-group col-md-6 col-12 float-left px-0 px-md-3">
                ...
                <input
                  ...
                  v-validate="'required'"
                />
                <small v-if="errors.first('branch_name')">{{
              ...
              <div class="form-group col-md-6 col-12 float-left px-0 px-md-3">
                ...
                >
                  ...
                  <option
                    :value="id"
                    v-for="{ id, name } in $store.getters.getStates"
                    :key="id"
                  >
                    {{ name | capitalize }}
                  </option>
              ...
              <div class="form-group col-md-6 col-12 float-left px-0 px-md-3">
                ...
                <input
                  ...
                  type="tel"
                  v-model="form.phone_english"
                  v-validate="'required|numeric|max:11|min:11'"
                />
                <small v-if="errors.first('phone_english')">{{
                  errors.first("phone_english")
                }}</small>
              </div>
              <div class="form-group col-md-6 col-12 float-left px-0 px-md-3">
                ...
                <input
                  ...
                  placeholder="081xxxxxxxx"
                  type="tel"
                  v-model="form.phone_yoruba"
                  v-validate="'required|numeric|max:11|min:11'"
                />
                <small v-if="errors.first('phone_yoruba')">{{
                  errors.first("phone_yoruba")
                }}</small>
              </div>
              <div class="spaceBetween mb-md-2 mb-0"></div>
              ...
              <div class="form-group col-md-6 col-12 float-left px-0 px-md-3">
                ...
                >
                  ...
                  <option
                    :value="category"
                    v-for="category in ['lifestyle', 'appliances', 'admin']"
                    :key="category"
                  >
                    {{ category | capitalize }}
                  </option>
                </select>
                <small v-if="errors.first('category')">{{
              ...
              <div class="form-group col-md-6 col-12 float-left px-0 px-md-3">
                ...
                >
                  ...
                  <option :value="id" v-for="{ id, name } in banks" :key="id">
                    {{ name | capitalize }}
                  </option>
                </select>
                <small v-if="errors.first('bank')">{{
                  errors.first("bank")
                }}</small>
              </div>
              <div class="spaceBetween mb-md-2 mb-0"></div>
              ...
              <div class="form-group col-md-6 col-12 float-left px-0 px-md-3">
                ...
                <input
                  ...
                  v-validate="'required'"
                />
                <small v-if="errors.first('account_name')">{{
              ...
              <div class="form-group col-md-6 col-12 float-left px-0 px-md-3">
                ...
                <input
                  :class="{ 'is-invalid': error.account_number }"
                  class="form-control"
                ...
                />
                <small v-if="errors.first('account_number')">{{
                  errors.first("account_number")
                }}</small>
                <small v-if="error.account_number">{{
            ...
            <div
              class="col-sm-12 ml-auto mr-auto mt-md-2 mt-0 px-md-3 px-1 mb-3"
            >
...
<script>
  ...
  function initialize(to) {
    let urls = {
      ...
      edit: `/api/branch/${to.params.id}/edit`,
    };
              ...
              byMethod(this.method, this.store, this.form)
                .then(({ data }) => {
                  if (data.saved || data.updated) {
                    ...
                    Flash.setSuccess(
                      `Branch ${this.mode}d successfully!`,
                      20000
                    );
                  }
                })
