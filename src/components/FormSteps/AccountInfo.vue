  ...
  <div>
    ...
    <div>
      ...
      <div class="form-group col-md-4 px-md-3 px-1 float-left">
        ...
        <div
          v-if="memberHasError('newCustomer.first_name')"
      ...
      <div class="form-group col-md-4 px-md-3 px-1 float-left">
        ...
        <div
          ...
          class="invalid-feedback"
        >
          <div class="error" v-if="!$v.formData.newCustomer.last_name.required">
      ...
      <div class="form-group col-md-4 px-md-3 px-1 float-left">
        ...
        />
        <div
          v-if="memberHasError('newCustomer.telephone')"
          class="invalid-feedback"
        >
          <div class="error" v-if="!$v.formData.newCustomer.telephone.required">
      ...
      <div class="form-group col-md-4 px-md-3 px-1 float-left">
        ...
        />
        <div
          v-if="memberHasError('newCustomer.email')"
          class="invalid-feedback"
        >
          <div class="error" v-if="!$v.formData.newCustomer.email.required">
      ...
      <div class="form-group col-md-4 px-md-3 px-1 float-left">
        ...
        <input
          ...
          :class="
            memberHasError('newCustomer.date_of_birth') ? 'is-invalid' : ''
          "
          v-validate="'required'"
        />
        <div
          v-if="memberHasError('newCustomer.date_of_birth')"
          class="invalid-feedback"
        >
          <div
            class="error"
      ...
      <div
        ...
        :class="
          formData.newCustomer.civil_status === 'single'
            ? 'col-md-12'
            : 'col-md-8'
        "
      >
        ...
        <div class="radio pl-1 float-left">
          <input
            ...
            :class="
              memberHasError('newCustomer.civil_status') ? 'is-invalid' : ''
            "
            v-validate="'required'"
          />
          <label for="single">single</label>
          <div
            v-if="memberHasError('newCustomer.civil_status')"
            class="invalid-feedback"
          >
            <div
              class="error"
      ...
      <div
        class="spaceAfter"
        style="flex-direction: row; justify-content:"
      ></div>
      <div class="form-group col-md-2 px-md-3 px-1 float-left">
        ...
        <div class="radio pl-1 float-left">
          ...
          <div
            v-if="memberHasError('newCustomer.gender')"
            class="invalid-feedback"
          >
            <div class="error" v-if="!$v.formData.newCustomer.gender.required">
              Gender is required.
            </div>
          </div>
        </div>
      ...
      <div class="form-group col-md-3 px-md-3 px-1 float-left">
        ...
        <select
          ...
          v-model="formData.newCustomer.registration_channel"
          name="registration_channel"
          placeholder="Enter channel.."
          type="registration_channel"
          :class="
            memberHasError('newCustomer.registration_channel')
              ? 'is-invalid'
              : ''
          "
        >
          <option value="Website" selected>Website</option>
          <option :value="channel" v-for="channel in channels" :key="channel">
            {{ channel }}
          </option>
        </select>
        <div
          v-if="memberHasError('newCustomer.registration_channel')"
          class="invalid-feedback"
        >
          <div
            class="error"
          ...
          >
            Please provide your channel.
          </div>
        </div>
      </div>
      <div class="form-group col-md-7 px-md-3 px-1 float-left">
        <label class="w-100 float-left pl-1 pr-5"
        ...
        <div class="radio pl-1 float-left">
          <input
            ...
            :class="
              memberHasError('newCustomer.level_of_education')
                ? 'is-invalid'
                : ''
            "
            v-validate="'required'"
      ...
      <div class="form-group col-md-12 px-md-3 px-1 float-left">
        ...
        <div v-if="memberHasError('newCustomer.bvn')" class="invalid-feedback">
          <div class="error" v-if="!$v.formData.newCustomer.bvn.minLength">
            The minimum bvn is 11 digits.
          </div>
        </div>
        <div v-if="memberHasError('newCustomer.bvn')" class="invalid-feedback">
          <div class="error" v-if="!$v.formData.newCustomer.bvn.maxLength">
            The maximum bvn is 11 digits.
          </div>
        </div>
      </div>
    </div>
