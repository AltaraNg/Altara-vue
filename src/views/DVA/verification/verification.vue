                ...
                <div :class="DivClassNewDoc(type)" class="card card-stats">
                  ...
                  >
                    <div>
                      ...
                      <small
                        v-if="!displayActiveDocument(type)"
                        style="font-size: 9px"
                        >(Click here to update status!)</small
                      >
                    </div>
                    <div
                      v-for="(item, index) in customer.new_documents"
                      :key="index"
                      class=""
                    >
      ...
      <div v-if="action !== 'update'">
        ...
        >
          <div
            ...
            :style="{
              pointerEvents:
                type == 'passport' || type == 'id_card' ? 'none' : 'auto',
            }"
          >
        ...
        <div
          :id="type + '_modal'"
          class="modal fade"
          v-for="(type, index) in newDocView"
          :key="index"
        >
          <div
            class="modal-dialog"
  ...
  export default {
    ...
    methods: {
      ...
      displayActiveDocument(document) {
        return this.customer.new_documents.find(
