...
export const store = new Vuex.Store({
  ...
  mutations: {
    ...
    mutateUncontacted: (state, uncontacted) =>
      Vue.set(state, "uncontacted", uncontacted),
    mutatePaymentMethods: (state, paymentMethods) =>
      Vue.set(state, "paymentMethods", paymentMethods),
    mutateTypeaheadUsersList: (state, typeaheadUsersList) =>
      Vue.set(state, "typeaheadUsersList", typeaheadUsersList),
  ...
  actions: {
    ...
    mutateUncontacted: ({ commit }, uncontacted) =>
      commit("mutateUncontacted", uncontacted),
    mutateBranches: ({ commit }, branches) =>
      commit("mutateBranches", branches),
    mutateProfileAccess: ({ commit }, payload) =>
      commit("mutateProfileAccess", payload),
    mutatePaymentMethods: ({ commit }, paymentMethods) =>
      commit("mutatePaymentMethods", paymentMethods),
    mutateTypeaheadUsersList: ({ commit }, typeaheadUsersList) =>
      commit("mutateTypeaheadUsersList", typeaheadUsersList),
