            ...
            <div class="clearfix">
              <h5>
                ...
                <span class="float-right" v-if="mode === 'edit'">
                  <a
                    href="javascript:"
                    class="text-link mr-5 float-left"
              ...
              <div class="form-group col-md-6 col-12 float-left px-0 px-md-3">
                ...
                <small v-if="error.date_of_birth">{{
              ...
              <div
                class="form-group col-md-6 col-12 float-left px-0 px-md-3"
                v-if="mode === 'edit'"
              >
              ...
              <div
                class="spaceBetween mb-md-2 mb-0"
                v-if="mode === 'edit'"
              ></div>
              ...
              <div class="form-group col-md-6 col-12 float-left px-0 px-md-3">
                <div>
                  <div v-if="mode === 'edit' && $data.form['cv_url']">
                    <a @click="viewCV(form.cv_url)" class="view_cv mr-4">{{
                      form.cv_url.substring(3)
                    }}</a>
                    ||
                    <a @click="form.cv_url = ''" class="view_cv ml-4"
                      >Edit CV</a
                    >
                  </div>
                  <div v-else>
...
<script>
  ...
  export default {
    ...
    beforeRouteEnter(to, from, next) {
      get(`/api/${initialize(to)}`).then(({ data }) =>
    ...
    methods: {
      ...
      viewCV(path) {
        window.open(
          `https://s3.eu-west-2.amazonaws.com/altara-one/${path}`,
          "_blank"
        );
      },
    },
