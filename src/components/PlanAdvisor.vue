<template>
    <div style="margin-left: 5rem; margin-right: 5rem">
        <AutocompleteSearch title="Formal Recommendation Service" @customer-selected="processForm" :url="'/api/customer/autocomplete'" />
        <form-wizard
            v-if="customer"
            ...
            <tab-content title="Customer Details" :before-change="beforeTabSwitch1">
                <div class="row">
                    <div class="col form-group">
                        <label for="custom-date" class="form-control-label">Total Product Price </label>
                        <currency-input v-model="form1[0]" class="form-control w-100" :options="inputOptions" />
                    </div>

                    <div class="col form-group">
                        <label for="custom-date" class="form-control-label">Monthly Salary </label>
                        <currency-input v-model="form1[1]" class="form-control w-100" :options="inputOptions" />
                    </div>
                </div>
            </tab-content>
            <tab-content title="Plan Details" :before-change="beforeTabSwitch2">
                <div class="row">
                    <div class="col form-group">
                        ...
                        <select class="custom-select w-100" v-model="form2[0]" v-validate="'required'">
                    ...
                    <div class="col form-group">
                        ...
                        <select class="custom-select w-100" v-model="form2[1]" v-validate="'required'">
                ...
                <div class="row">
                    <div class="col form-group">
                        ...
                        <select class="custom-select w-100" v-model="form2[2]" v-validate="'required'">
