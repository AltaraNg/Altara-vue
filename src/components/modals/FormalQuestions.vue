    ...
    <div>
      ...
      <div class="modal-body mx-4">
        <div class="d-flex align-items-center justify-content-between">
          <h4>
            This section is Formal,
            <strong @click="verifyInformalModal"
              >Click to view the Informal section</strong
            >
          </h4>
          <div
        ...
        <h4>
          Click to view
          <strong @click="verifyGuarantorModal">Guarantor section</strong>
        </h4>
        ...
        <form>
          ...
          <div class="form-group my-3">
            <label for="checklist4" class="">Is customer married? </label><br />
            <div class="form-check form-check-radio form-check-inline">
              <label class="form-check-label">
                <input
          ...
          <div class="form-group my-3">
            <label for="checklist"
              >If Yes - What is the name of their husband / wife and what is
              their number</label
            >
            <textarea
              cols="2"
          ...
          <div class="form-group my-3">
            <label for="exampleFormControlSelect2"
              >How long has the customer lived at his/her location?
            </label>
            <br />
          ...
          <div class="form-group my-3">
            <label for="customerTravels"
              >Does the customer travel often?
            </label>
            <br />
          ...
          <div class="form-group my-3">
            <label for="workingYears"
              >How many years has the customers been working with the company (
              >1 year) ? if Office/Business is verified
            </label>
            <br />
            <div
              class="form-check form-check-radio form-check-inline"
          ...
          <div class="form-group my-3">
            ...
            <div class="form-group my-3">
              <textarea
                ...
                rows="3"
              ></textarea>
              <small v-if="errors.first('date_of_salary')"
  ...
  export default {
    ...
    data() {
      return {
        ...
        locationDurationOptions: [
          "less than 6 months",
          "6months - 1 year",
          "More than 1 year",
        ],
        customerWorkingYearsOptions: [
          "less than 6 months",
          "6months - 1 year",
          "More than 1 year",
        ],
        ...
        this.$validator.validateAll().then(async (result) => {
          if (result) {
            try {
              ...
              const isGenericSectionFilled = genericRequiredKeys.every(
                (key) => this.verificationData[key] !== undefined
              );
              ...
              const isHomeSectionFilled = homeRequiredKeys.every(
                (key) => this.verificationData[key] !== undefined
              );
              ...
              const isOfficeSectionFilled = officeRequiredKeys.every(
                (key) => this.verificationData[key] !== undefined
              );

              if (
                isGenericSectionFilled &&
                (isHomeSectionFilled || isOfficeSectionFilled)
              ) {
                let res = await post(
                  "/api/recommendation",
