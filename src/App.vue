                        ...
                        <div class="collapse navbar-collapse justify-content-end" id="navigation">
                            <ul class="navbar-nav">
                                ...
                                <li class="nav-item mt-2 position-relative pl-2" v-if="canView && flag === 'beta'">
                                    <router-link :to="authState.role === roles.cash_loan_agent ? '/cashloan/renewal?fromDate=&tab=nc&unContactedRenewalPrompters=true' : '/dsa/renewal?fromDate=&tab=nc&unContactedRenewalPrompters=true'">
