<template>
    <div>
        <div class="modal-header py-2">
            <h6 class="modal-title py-1">Repayment Plan/Summary - {{ customer.employment_status | capitalize }}</h6>
                ...
                <div class="amor-table">
                    <table class="table table-bordered">
                        <tbody class="text-center">
                            <tr>
                                <th>Repayment</th>
                                <td v-for="(armor, index) in amortizationData" :key="armor" v-html="index + 1"></td>
                            </tr>
                            <tr class="table-separator">
                                <th>Due Date</th>
                                <td v-for="armo in amortizationData" :key="armo.expected_payment_date">
                            ...
                            <tr>
                                ...
                                <td v-for="(armo, index) in amortizationData" :key="index" @click="updateAmmo(armo, index)" class="pointer">
                ...
                <table class="table table-bordered">
                    <tbody class="text-center">
                        <tr class="table-separator">
                            ...
                            <th>
                                {{ order.discount[0] ? order.discount[0].name : "Null" | capitalize }}
                            </th>
        ...
        <div :class="{ 'd-flex justify-content-end': !canEditPayment || isReadOnly }" class="modal-footer">
            <a @click="$emit('close')" class="text-link mt-3" data-dismiss="modal" href="javascript:" style="text-align: right">close dialogue</a>
        </div>
