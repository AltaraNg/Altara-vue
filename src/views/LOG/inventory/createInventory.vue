      ...
      <div class="attendance-body" v-if="mode === 'create'">
        ...
        <div v-if="inventoryList.products.length > 0">
          ...
          <div
            ...
            v-for="(item, index) in inventoryList.products"
            :key="index"
          >
            <div
          ...
          if (result) {
            if (this.$network()) {
              ...
              put(this.store, this.form).then(() => {
                ...
                this.$router.push({ path: "/log/inventory" });
              });
