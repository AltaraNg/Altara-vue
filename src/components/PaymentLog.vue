    ...
    methods: {
      ...
      async logSale() {
        ...
        const data = {
          ...
          fixed_repayment: !this.showRepaymentToggle
            ? true
            : this.FixedRepayment,
          ...
          payment_method_id: this.isAltaraPay
            ? this.transfer
              ...
              : this.getPaymentMethods.find((el) => (el.name = "direct-debit"))
                  .id
        ...
        data.fixed_repayment =
          this.salesLogForm.business_type_id?.slug.includes("bs")
            ? false
            : data.fixed_repayment;
      ...
      async previewAmortization() {
        ...
        if (this.card_expiry) {
          ...
          let duration = parseInt(
            this.salesLogForm.repayment_duration_id.value
          );
      ...
      async toggleProductType(mode) {
        if (mode === "ap") {
          ...
          this.salesLogForm.repayment_duration_id =
            this.repaymentDuration.filter(
