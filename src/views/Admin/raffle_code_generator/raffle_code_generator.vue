    ...
    <div class="pt-5 mt-5 child-div-1">
      <div class="form-group" style="position: relative">
        ...
        <button
          ...
          class="bg-default"
          type="submit"
          :disabled="phone_number.length < 11 || phone_number.length > 15"
      ...
      <p style="margin-top: -3px">
        Please enter a valid phone number using the format: 080XXXXXXXX (11
        digits).
      </p>
      <div v-if="result" class="mt-5 pt-5 pr-5 mr-5">
        <div class="paragraph-container">
          <span style="margin-right: 30px">The raffle code for </span>
          <CopyItem :item="phone_number" />
          <span style="margin-left: 30px; margin-right: 20px">is</span>
          <CopyItem
            :item="raffle_code"
...
<script>
  ...
  export default {
    ...
    methods: {
      ...
      formatPhoneNumber() {
        const cleanPhoneNumber = this.phone_number
          .replace(/\D/g, "")
          .slice(-10);
