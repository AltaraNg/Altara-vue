        ...
        <form @submit.prevent="register">
          ...
          <div>
            ...
            <div
              v-if="
                mode === 'register' ||
                $store.getters.auth('DVAAccess') ||
                $store.getters.auth('DSAAccess')
              "
            >
          ...
          <div v-if="mode === 'register'">
            ...
            <div class="form-group col-md-3 col-6 px-md-3 px-1 float-left">
              <label class="w-100 float-left pl-1"
                >Loan From other Institutions</label
              >
            ...
            <div class="form-group mb-5 col-md-12 px-md-3 px-1 float-left">
              ...
              &nbsp;
              <div
                class="form-group col-md-3 col-12 px-md-3 px-1 mt-2 float-left"
              >
            ...
            <div class="form-group col-md-12 px-md-3 px-1 float-left">
              ...
              <div
                class="radio p-0 col-md-2 col-4 float-left"
                v-for="(rela, index) in relationships"
                :key="index"
              >
                <input
                  :id="rela"
          ...
          <div v-if="fillWorkGuarantor">
            ...
            <div class="form-group col-md-9 col-sm-12 px-md-3 px-1 float-left">
              <label class="w-100 float-left pl-1">Relationship</label>
              <div
                class="radio p-0 col-md-3 col-6 float-left"
                v-for="(rela, index) in relationshipWG"
                :key="index"
              >
                <input
                  :id="rela + 'wg'"
            ...
            <div class="form-group col-md-3 col-sm-6 px-md-3 px-1 float-left">
              <label class="w-100 float-left pl-1">Gender</label>
              <div
                class="radio p-0 col-6 float-left"
                v-for="(sex, index) in gender"
                :key="index"
              >
                <input
          ...
          <div v-if="fillPersonalGuarantor">
            ...
            <div class="form-group col-md-9 col-sm-12 px-md-3 px-1 float-left">
              ...
              <div
                class="radio p-0 col-md-3 col-6 float-left"
                v-for="(rela, index) in relationshipPG"
                :key="index"
              >
                <input
                  :id="rela + 'pg'"
...
<script>
  ...
  export default {
    ...
    computed: {
      ...
      cannotView: function () {
        return [roles.dsa_captain, roles.dsa].includes(this.authState.role);
      },
      ...mapGetters(["auth"]),
    },
    created() {
